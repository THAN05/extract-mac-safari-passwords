...
You should now have the file named B<pm_export.json> on your Desktop- use this file name on the command line.
...
sub do_import {
    ...
    # some change in version 6 is adding newlines to the end of the file
    $data =~ s/\R+$//;
